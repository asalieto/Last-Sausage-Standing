...
//#node6:posx=-375:posy=-58:title=GlobalTexture:title2=ReflectionTex2:input0=(0,0):input0type=Vector2:input0linkindexnode=17:input0linkindexoutput=0:
...
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/Reflection2" {
	Properties {
...
float4 node6 = tex2D(_ReflectionTex2,((IN.planeReflectionUV.xy/IN.planeReflectionUV.w) + (((float2(1.0/_ScreenParams.x,1.0/_ScreenParams.y)) * ((float4(float3(UnpackNormal((node15))),0)).xy)) * (_ReflectionDistortion))));
